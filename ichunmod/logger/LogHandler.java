...
public class LogHandler {
    ...
    private static Logger ichunmodLogger = Logger.getLogger(Reference.MOD_ID);

    public static void init() {
    	ichunmodLogger.setParent(FMLLog.getLogger());
    }

    public static void log(Level logLevel, Object object) {
        ichunmodLogger.log(logLevel, object.toString());
    }
